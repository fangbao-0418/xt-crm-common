...
import { deleteArticle, getAllColumn, getArticleList, modifyArticleStatus, modifyTopStatus } from './api'
      ...
      return (
        <>
          ...
          <span
            ...
            data-clipboard-text={`${h5Host}/pop/index.html#/pages/find/articleDetail/index?id=${record.id}`}
          >
            复制链接
          </span>
