...
import CompensateDownload from './compensate-download'
import AfterListDownload from './after-list-download'
  ...
  render () {
    ...
    return (
      <Switch>
        ...
        <Route path={`${match.url}/compensate-download`} component={CompensateDownload} />
        <Route path={`${match.url}/after-list-download`} component={AfterListDownload} />
