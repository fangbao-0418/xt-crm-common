...
import { Input, Button, Form, Table, Modal, InputNumber, message } from 'antd';
    ...
    renderForm = () => {
        ...
        return (
            <Form layout='inline'>
                ...
                <FormItem>
                    <Button style={{ lineHeight: 1 }} type="primary" onClick={this.handleSearch}>查询</Button>
                    <Button onClick={this.resetFields} style={{ marginLeft: 8, lineHeight: 1 }}>清除条件</Button>
                </FormItem>
            </Form>
        )
    }
