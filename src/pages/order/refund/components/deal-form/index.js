...
class DealForm extends Component {
  ...
  render() {
    ...
    // }
    // 退货退款
    // if (['21', '22'].includes(orderServerVO.refundType)) {
    //   tabList.push({
    ...
    return (
      ...
      <>
        ...
        {['21', '22'].includes(orderServerVO.refundType) && <RefundInformation readOnly={false}/>}
        {['21', '24'].includes(orderServerVO.refundType) && <DeliveryInformation readOnly={false} checkType={checkType} refundType={orderServerVO.refundType} />}
      </>
    )
  }
}
