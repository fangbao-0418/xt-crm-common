...
class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    document.querySelector('section.ant-layout').getElementsByClassName('ant-layout')[0].scrollTop = 0;
  }
  ...
  render() {
    ...
    const productImageList = compact(
      ((goodsInfo.productImage || '')).split(',').map((url) => initImgList(url)[0])
    );

    const listImage = compact(
      (goodsInfo.listImage || '').split(',').map((url) => initImgList(url)[0])
    )
    ...
    return (
      <>
            ...
            <Row>
              <Col span={24}>
                <div className={styles['item']}>
                  ...
                  <span className={styles['item-box']}>
                    (
                    <Upload listType="picture-card" fileList={initImgList(goodsInfo.videoCoverUrl)} />)
                  </span>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col span={24}>
                <div className={styles['item']}>
                  ...
                  <span className={styles['item-box']}>
                    <Upload listType="picture-card" fileList={initImgList(goodsInfo.videoUrl)} />
                  </span>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col span={24}>
                <div className={styles['item']}>
                  ...
                  <span className={styles['item-box']}>
                    <Upload listType="picture-card" fileList={initImgList(goodsInfo.coverUrl)} />
                  </span>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col span={24}>
                <div className={styles['item']}>
                  ...
                  <span className={styles['item-box']}>
                    <Upload listType="picture-card" fileList={initImgList(goodsInfo.bannerUrl)} />
                  </span>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col span={24}>
                <div className={styles['item']}>
                  ...
                  <span className={styles['item-box']}>
                    <Upload listType="picture-card" fileList={productImageList} />
                  </span>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col span={24}>
                <div className={styles['item']}>
                  ...
                  <span className={styles['item-box']}>
                    <Upload listType="picture-card" fileList={listImage} />
                  </span>
                </div>
              </Col>
            </Row>
        ...
        <Modal
          ...
          visible={visible}
        >
          <img alt="img" src={skuInfo.imageUrl1} />
        </Modal>
      </>
    );
  }
