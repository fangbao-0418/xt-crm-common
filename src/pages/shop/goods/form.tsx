...
import { getStoreList, setProduct, getGoodsDetial, getStrategyByCategory, getCategoryList, get1688Sku, getTemplateList } from '@/pages/goods/api';
import { gotoPage, parseQuery, getAllId, treeToarr } from '@/util/utils';
import { radioStyle } from '@/config';
import SkuList from '@/pages/goods/components/sku';
import SupplierSelect, { supplierItem } from '@/pages/goods/components/supplier-select';
import { TemplateList } from '@/components';
import styles from '../style.module.scss';
import { Form, FormItem, If } from '@/packages/common/components';
import ProductCategory from '@/pages/goods/components/product-category';
import ProductSelector from './components/product-seletor';
import { defaultConfig } from './config';
import DraggableUpload from '@/pages/goods/components/draggable-upload';
