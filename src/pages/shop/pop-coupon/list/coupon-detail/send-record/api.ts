...
export const fetchTaskList = (payload: Partial<TaskListPayload>) => {
  return newPost('/mcweb/coupon/task/getPage', payload)
}
...
export const addTask = (payload: Partial<AddTaskPayload>) => {
  return newPost('/mcweb/coupon/task/add', payload)
}

/** 编辑任务 */
export const updateTask = (payload: Partial<AddTaskPayload>) => {
  return newPost('/mcweb/coupon/task/update', payload)
}

export const fetchTaskDetail = (id: any) => {
  return get(`/mcweb/coupon/task/getById?id=${id}`)
}
...
export const stopTask = (id: any) => {
  return newPost('/mcweb/coupon/task/stop', {
    id
  })
}
...
export const invalidateTask = (id: any) => {
  return newPost('/mcweb/coupon/task/invalidate', {
    id
  })
}