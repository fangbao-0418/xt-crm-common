...
class Main extends React.Component<Props, State> {
  ...
  public onOk () {
    if (this.props.onOk) {
      ...
      this.props.onOk(
        this.limit ? selectedRowKeys.slice(0, this.limit) : selectedRowKeys,
        this.limit ? selectedRows.slice(0, this.limit) : selectedRows
      )
      this.setState({
        visible: false
      })
  ...
  public onrowSelectionChange (selectedRowKeys: any[], selectedRows: Shop.CouponProps[]) {
    if (this.limit && selectedRowKeys.length > this.limit) {
      APP.error(`最多只能选择${this.limit}张优惠券`)
    }
    this.setState({
      selectedRowKeys: this.limit ? selectedRowKeys.slice(0, this.limit) : selectedRowKeys
    })
  }
  ...
  public open (value?: Shop.CouponProps[]) {
    value = value || []
    this.payload = {
      isDelete: 0,
      page: 1,
